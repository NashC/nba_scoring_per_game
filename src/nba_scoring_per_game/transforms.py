...
def summarize_player_games(
    ...
    summary = (
        ...
        .agg(
            ...
            opponent_wins=("opponent_wins", "first"),
            opponent_losses=("opponent_losses", "first"),
            opponent_win_pct=("opponent_win_pct", "first"),
            opponent_record_scope=("opponent_record_scope", "first"),
            is_playoff_game=("is_playoff_game", "first"),
            ...
            results.append(
                {
                    ...
                    "opponent_wins": base_row["opponent_wins"],
                    "opponent_losses": base_row["opponent_losses"],
                    "opponent_win_pct": base_row["opponent_win_pct"],
                    "opponent_record_scope": base_row["opponent_record_scope"],
                    "is_playoff_game": base_row["is_playoff_game"],
